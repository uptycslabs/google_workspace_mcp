...
async def get_presentation(
    ...
    Returns:
        str: JSON with presentation details including title, slides, and page size.
    """
    logger.info(
...
@server.tool(
    annotations={
        "title": "Presentation Page Retriever",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
...
async def get_page(
    ...
    Returns:
        str: JSON with page details including elements and layout.
    """
    logger.info(
...
@server.tool(
    annotations={
        "title": "Presentation Page Thumbnail Generator",
        "readOnlyHint": True,
        "destructiveHint": False,
        "idempotentHint": True,
        "openWorldHint": True,
...
async def get_page_thumbnail(
    ...
    Returns:
        str: JSON with thumbnail URL and metadata.
    """
    logger.info(
